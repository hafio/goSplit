...
## Corpus Check
- 122 files · ~78,412 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1114 nodes · 2131 edges · 135 communities (59 shown, 76 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 335 edges (avg confidence: 0.81)
...
## Communities (135 total, 76 thin omitted)
...
Cohesion: 0.08
Nodes (30): CancelFunc, balanceRow, currencyNet, friendRow, groupRow, settlementRow, Server, Request (+22 more)

### Community 2 - "Expense Handlers & Money"
Cohesion: 0.07
Nodes (37): candidate, expenseDetailView, participantView, absInt64(), Server, Request, ResponseWriter, displayName() (+29 more)

### Community 3 - "Server Wiring & Auth Middleware"
Cohesion: 0.07
Nodes (31): ctxKey, Manager, HandlerFunc, CSRFFrom(), Context, Handler, Request, ResponseWriter (+23 more)
...
Cohesion: 0.07
Nodes (32): main(), parseLogLevel(), run(), Config, Engine, DB, getEnv(), getEnvBool() (+24 more)
...
Cohesion: 0.19
Nodes (8): Context, Service, toISO(), Context, Store, scanRecurrence(), ExpenseRecurrence, Time
...
Cohesion: 0.19
Nodes (7): prefixCols(), trimSpace(), Context, Store, scanGroup(), NullString, Group
...
Cohesion: 0.15
Nodes (12): Context, Existing mechanism (reuse, do not reinvent), GoSplit: Complete i18n Coverage — Implementation Plan, Ledger, Phase 1 — Plumbing (small, do first), Phase 2 — Templates, Phase 3 — Go handler strings, Phase 4 — JS status strings (bank.js, push.js) (+4 more)
...
## Knowledge Gaps
- **181 isolated node(s):** `github.com/hafio/gosplit`, `ctxKey`, `collapseView`, `bankTxRow`, `balanceRow` (+176 more)
...
- **Why does `User` connect `Group Store Queries` to `User Service, Store & Auth`, `HTTP Page & Settlement Handlers`, `Expense Handlers & Money`, `Server Wiring & Auth Middleware`, `New`, `.AdminCreateUser`, `Bank Sync (Plaid)`, `.ImportFromSplitwise`, `.UpdateAvatar`, `Theme Color System`, `Expense Service Logic`?**
