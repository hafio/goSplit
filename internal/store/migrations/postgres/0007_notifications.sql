...
-- Per-user opt-in for the expense email. Default false: the notification row
-- above is always written and is the default channel, so email is purely
-- additive and nobody keeps receiving mail they never asked for.
ALTER TABLE users ADD COLUMN email_expense_notify BOOLEAN NOT NULL DEFAULT false;
